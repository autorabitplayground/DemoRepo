...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>DemoAccountTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>Demo_Account</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>true</custom>
    <fieldPermissions>
        <editable>true</editable>
        <field>AccentureDemo__c.CF_AccentureDemo__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>AccentureDemo__c-AccentureDemo Layout</layout>
    </layoutAssignments>
    <objectPermissions>
        ...
        <object>AccentureDemo__c</object>
